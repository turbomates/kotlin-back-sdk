...
dependencyResolutionManagement {
    versionCatalogs {
        create("deps") {
            ...
            version("postgresql_jdbc", "42.7.11")
            version("swagger_webjar", "4.15.5")
            version("embedded_postgres", "1.1.1")
            version("rabbitmq_amqp_client", "5.30.0")
            version("kotlin_serialization_json", "1.11.0")
            version("email", "1.6.2")
            version("greenmail", "2.1.7")
            version("tmsoft_time", "0.2.3")
            version("opentelemetry", "1.55.0")
            version("prometheus_micrometer", "1.15.5")
            version("slf4j_coroutines", "1.10.2")
            ...
            library("tmsoft_time", "com.turbomates", "time").versionRef("tmsoft_time")
            ...
            plugin("sentry", "io.sentry.jvm.gradle").versionRef("sentry")
            bundle(
                "turbomates", listOf(
                    "tmsoft_time"
                )
